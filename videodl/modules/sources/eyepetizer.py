...
class EyepetizerVideoClient(BaseVideoClient):
    ...
    def __init__(self, **kwargs):
        ...
        self.default_parse_headers = {
            "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36", "x-thefair-appid": "xfpa44crf2p70lk8", "x-thefair-auth": "", "x-thefair-cid": "", "x-thefair-forward-host": "https://api.eyepetizer.net",
    ...
    def parsefromurl(self, url: str, request_overrides: dict = None):
        ...
        try:
            ...
            video_title = legalizestring(safeextractfromdict(raw_data, ['result', 'video', 'title'], null_backup_title) or null_backup_title, replace_null_string=null_backup_title).removesuffix('.')
            download_url = raw_data["result"]["video"]["play_url"]
            play_info = safeextractfromdict(raw_data, ['result', 'video', 'play_info'], {}) or {}
