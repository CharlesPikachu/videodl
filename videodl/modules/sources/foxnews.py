...
from ..utils import legalizestring, useparseheaderscookies, resp2json, searchdictbykey, FileTypeSniffer, VideoInfo
    ...
    def parsefromurl(self, url: str, request_overrides: dict = None):
        ...
        try:
            ...
            video_title = legalizestring(
                video_title[0] if video_title else f'{self.source}_null_{date_str}', replace_null_string=f'{self.source}_null_{date_str}',
            ).removesuffix('.')
