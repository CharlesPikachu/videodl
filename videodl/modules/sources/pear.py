...
class PearVideoClient(BaseVideoClient):
    ...
    def __init__(self, **kwargs):
        ...
        self.default_download_headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', 'Referer': 'https://www.pearvideo.com/'}
    ...
    def parsefromurl(self, url: str, request_overrides: dict = None):
        ...
        try:
            ...
            cover_url = safeextractfromdict(raw_data, ['videoInfo', 'video_image'], None)
    ...
    def belongto(url: str, valid_domains: list[str] | set[str] = None):
        valid_domains = set(valid_domains or []) | {'pearvideo.com'}
