...
class CommonVideoClientBuilder(BaseModuleBuilder):
    REGISTERED_MODULES = {
        ...
        'XCVTSVideoClient': XCVTSVideoClient,           'LongZhuVideoClient': LongZhuVideoClient,   'XiazaitoolVideoClient': XiazaitoolVideoClient,   'ZanqianbaVideoClient': ZanqianbaVideoClient,
        'XZDXVideoClient': XZDXVideoClient,             'LvlongVideoClient': LvlongVideoClient,
    }
