...
class CommonVideoClientBuilder(BaseModuleBuilder):
    REGISTERED_MODULES = {
        ...
        'XiazaitoolVideoClient': XiazaitoolVideoClient, 'GVVIPVideoClient': GVVIPVideoClient, 'ZanqianbaVideoClient': ZanqianbaVideoClient, 'XZDXVideoClient': XZDXVideoClient,
    }
