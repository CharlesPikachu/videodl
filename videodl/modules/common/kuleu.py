'''
Function:
    Implementation of KuLeuVideoClient: https://api.kuleu.com/doc/jiexi.html
Author:
    Zhenchao Jin
...
'''KuLeuVideoClient'''
class KuLeuVideoClient(BaseVideoClient):
    source = 'KuLeuVideoClient'
    def __init__(self, **kwargs):
        super(KuLeuVideoClient, self).__init__(**kwargs)
    ...
    def parsefromurl(self, url: str, request_overrides: dict = None) -> list[VideoInfo]:
        ...
        try:
            ...
            (resp := self.get("https://api.kuleu.com/api/jiexi", params={"url": url}, headers=headers, **request_overrides)).raise_for_status()
