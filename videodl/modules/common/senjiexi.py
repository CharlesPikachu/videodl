...
class SENJiexiVideoClient(BaseVideoClient):
    ...
    def parsefromurl(self, url: str, request_overrides: dict = None):
        ...
        try:
            ...
            # --post requests
            (resp := self.post("https://jiexi.789jiexi.icu:4433/api.php", data={'url': url, 'time': raw_data['time'], 'key': raw_data['key']}, headers=headers, **request_overrides)).raise_for_status()
